...
function crearTabla() {
	...
	contenido += "<tr class='FilaCabecera'><th colspan='6' style='text-align:center'><a href='#' id='aExportarTexto'>Exportar Texto<a/>&nbsp;&nbsp;<a href='#' id='aExportarExcel'>Exportar Excel</a></th>";
